...
# Нода валидатора сети Crowd Control, развертка в Akash Network.
...
| [Discord Crowd Control](https://discord.gg/tQzuyCEwjg) | [Explorer Crowd Control](https://explorer.kjnodes.com/cardchain) | [Site Crowd Control](https://crowdcontrol.network/#/about) | [Twitter Crowd Control](https://twitter.com/CrowdControlNet) |
|:--:|:--:|:--:|:--:|
...
# English version
### Deployment of the Crowd Control node.

Deploy [deploy.yml](https://github.com/Dimokus88/Crowd_Control/blob/main/deploy.yml) **Crowd Control** nodes with **Cloudmos (Akashlytics)** ( [use instructions here](https://github.com/Dimokus88/guides/blob/main/Akashlytics/EN-guide.md) ) by setting the values ​​in the corresponding `deploy.yml` variables:
...
### Creating an Crowd Control validator
...
You can delegate the remaining tokens to yourself, but leave 1,000,000 ubpf to pay for transaction gas:
...
___
# Русская версия
### Развертка ноды Crowd Control.

Разверните [deploy.yml](https://github.com/Dimokus88/Crowd_Control/blob/main/deploy.yml) ноды **Crowd Control** с помощью **Cloudmos (Akashlytics)**  ([инструкция по использованию здесь](https://github.com/Dimokus88/guides/blob/main/Akashlytics/RU-guide.md)) установив значения в соответствующих переменных  `deploy.yml`: 
...
### Создание валидатора Crowd Control
...
Можете делегировать на себя оставшиеся токены, но оставьте 1 000 000 ubpf для оплаты газа транзакций:
